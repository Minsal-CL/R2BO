ValueSet: ProfesionalesAutorizadosR2BO
...
* CSTituloProfesional#4 "ENFERMERAS(OS) MATRONAS(ES)"
* CSTituloProfesional#5 "MATRONAS(ES)"

ValueSet: EspecialistasAutorizadosR2BO
