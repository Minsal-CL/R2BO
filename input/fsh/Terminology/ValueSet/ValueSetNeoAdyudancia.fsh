...
* $loinc|2.82#LA26539-9 "Moderate response (Grade 1 - Single cells or small groups of cancer cells)"
* $loinc|2.82#LA26540-7 "Mminimal response (Grade 2 - Residual cancer outgrown by fibrosis)"
* $loinc|2.82#LA26541-5 "Poor response (Grade 3 - Minimal or no tumor kill; extensive)"