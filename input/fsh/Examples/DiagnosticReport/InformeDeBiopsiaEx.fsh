...
* result[3] = Reference(r2bo-observacion-ganglios-linfaticos-ex)
* result[4] = Reference(r2bo-observacion-infiltracion-perineural-ex)
* result[5] = Reference(r2bo-observacion-infiltracion-peritumoral-ex)
* result[6] = Reference(r2bo-observacion-invasion-linfatica-ex)
* result[7] = Reference(r2bo-observacion-invasion-vascular-ex)
* result[8] = Reference(r2bo-observacion-margen-quirurgico-ex)
* result[9] = Reference(r2bo-observacion-centricidad-ex)
* result[10] = Reference(r2bo-observacion-multifocalidad-ex)
* result[11] = Reference(r2bo-observacion-porcentaje-necrosis-ex)
* result[12] = Reference(r2bo-observacion-post-tratamiento-neoadjuvancia-ex)
* result[13] = Reference(r2bo-tamano-tumor-ex)
