Instance:       riap-solicitud-informe-apa-bundle
...
* type = #transaction
* entry[Solicitud]
  * fullUrl = "https://interoperabilidad.minsal.cl/fhir/ig/riap/ServiceRequest/riap-solicitud-informe-apa-1-ej"
  * resource = riap-solicitud-informe-apa-1-ej
  * request
    * method = #POST
    * url = "ServiceRequest"
...
Instance:   riap-solicitud-informe-apa-1-ej
