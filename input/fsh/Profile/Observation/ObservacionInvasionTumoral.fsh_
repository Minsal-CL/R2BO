Profile:        ObservacionInvasionTumoralR2BO
...
* code = $snomed#370052007
* value[x] only CodeableConcept
* value[x] from InvasionLinfaticaVascularVS (required)
* value[x] ^binding.description = "Posibles resultados de invasión tumoral en un reporte de biopsia"