...
* imports[0] = Canonical(ClCoreServidorCapabilityStatement)
* imports[+] = "https://interoperabilidad.minsal.cl/fhir/ig/nid/CapabilityStatement/MPI.IHE.PIXm.PDQm.Manager"
* imports[+] = "https://interoperabilidad.minsal.cl/fhir/ig/nid/CapabilityStatement/NID.IHE.HPD.Manager"
...
* rest
  ...
  * resource[+]
    ...
    * searchRevInclude[0] = "Composition:attester"
    * searchRevInclude[+] = "Composition:author"
    * searchRevInclude[+] = "DiagnosticReport:performer"
  ...
  * resource[+]
    ...
    * searchRevInclude[0] = "Composition:entry"
    * searchRevInclude[+] = "DiagnosticReport:based-on"
